...
Результатом работы [генератора](generator.md) является описание трехмерного конфигурационного пространства в формате JSON.
[Визуализатор](visualizer.md) способен прочитать данный формат и отобразить конфигурационное простанство в графическом виде.
...
В сгенерированном конфигурационном пространсве *гарантируется* отсутствие пересечений препятствий, а также то, что стартовая и конецная точки не будут находиться в запретной области.
